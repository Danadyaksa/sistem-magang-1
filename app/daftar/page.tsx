...
export default function RegistrationPage() {
  ...
  // Ganti function onSubmit yang lama dengan ini:
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // 1. Masukin semua data text dari formSchema ke FormData
      ...
      // 2. Masukin File Manual (Karena file input ga masuk otomatis di values react-hook-form biasanya)
      // Pastikan ID input file di JSX lo adalah "cv", "surat", "foto"
      const cvFile = (document.getElementById("cv") as HTMLInputElement)
        .files?.[0];
      const suratFile = (document.getElementById("surat") as HTMLInputElement)
        .files?.[0];
      ...
      // 4. Sukses! Redirect atau kasih notif
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <Link
          href="/"
          className="inline-flex items-center text-slate-500 hover:text-blue-700 mb-6 transition-colors"
        >
              ...
              >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Sesuai KTP/KTM" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription className="text-xs">
                            Diawali tanda petik satu (') dan kode negara 62.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Kosongkan jika siswa SMK/SMA"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="md:col-span-2">
                          ...
                          <FormControl>
                            <Input
                              placeholder="Contoh: Pendidikan Administrasi - S1"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            Pemohon Surat Izin Magang{" "}
                            <span className="text-red-500">*</span>
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder="Contoh: Wakil Dekan Bidang Akademik"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            Nomor Surat Izin Magang{" "}
                            <span className="text-red-500">*</span>
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder="Nomor surat resmi dari kampus"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                ...
                <div className="pt-6">
                  ...
                  <p className="text-xs text-center text-slate-500 mt-4">
                    Dengan mengirim form ini, Anda menyatakan data yang diisi
                    adalah benar.
                  </p>
                </div>
              </form>
