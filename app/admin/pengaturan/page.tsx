...
export default function PengaturanPage() {
  ...
  return (
    <div className="h-screen w-full bg-slate-50 dark:bg-slate-950 flex transition-colors duration-300 overflow-hidden">
      ...
      <aside 
        className={`
          fixed inset-y-0 left-0 z-40 bg-slate-900 text-white shadow-xl flex flex-col h-full transition-transform duration-300 ease-in-out
      ...
      >
        ...
        <nav className="p-3 space-y-2 flex-1 overflow-y-auto overflow-x-hidden">
          ...
          <SidebarItem icon={Settings} label="Pengaturan" active={true}/>
